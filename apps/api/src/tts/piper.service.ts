...
export class PiperService implements OnModuleInit {
    ...
    private readonly piperBinaryPath = path.resolve(process.env.PIPER_BIN || 'tools/piper-venv/bin/piper');
    private readonly modelsDir = path.resolve(process.env.PIPER_MODELS_DIR || 'tools/piper/models');
