...
import { SQLLevel } from './types';

interface SQLLevelSelectorProps {
  level: SQLLevel;
  currentLevel: number;
...
export function SQLLevelSelector({
  level,
  currentLevel,
  completedLevels,
  showHint,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-orange-50/50 to-amber-50/50 dark:from-orange-900/10 dark:to-amber-900/10">
