...
interface XSSSuccessModalProps {
  currentLevel: number;
  totalLevels: number;
...
export function XSSSuccessModal({
  currentLevel,
  totalLevels,
  explanation,
  onNextLevel,
}: XSSSuccessModalProps) {
  return (
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-green-800 dark:text-green-200 mb-1 flex items-center gap-2">
              <PartyPopper className="w-5 h-5" /> XSS Attack Successful!
            </h3>
        ...
        {currentLevel < totalLevels ? (
          ...
          <div className="p-4 rounded-lg bg-green-100 dark:bg-green-900/30">
            <p className="text-green-800 dark:text-green-200 font-medium flex items-center gap-2">
              <Trophy className="w-5 h-5" /> Congratulations! You&apos;ve completed all XSS challenges!
            </p>
          </div>
        )}
      </div>
